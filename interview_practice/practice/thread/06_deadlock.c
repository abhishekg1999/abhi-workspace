...
thread1 --> mutex2  [waiting.. to lock mutex2, because thread2 holding mutex2]
here both the thread will never get chance to finish it work , this is deadlock condition
